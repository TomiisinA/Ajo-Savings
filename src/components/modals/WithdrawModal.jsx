...
const WithdrawModal = ({ onClose, onWithdraw }) => {
  const [amount, setAmount] = useState("");

  return (
    <Modal title="Withdraw Funds" onClose={onClose}>
      <label htmlFor="withdraw-wallet-select" className="text-black-200 pb-4">
        Select Wallet
      </label>
      <select
      ...
      <div className="flex justify-start gap-3 mb-5">
        <Button onClick={() => onWithdraw(amount)}>Proceed</Button>
